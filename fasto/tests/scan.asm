...
# was:	mv	_let_b_15_, x3
	slli	x10, x18, 2
# was:	slli	_tmp_25_, _size_17_, 2
	addi	x10, x10, 4
# was:	addi	_tmp_25_, _tmp_25_, 4
	add	x3, x3, x10
# was:	add	x3, x3, _tmp_25_
	sw	x18, 0(x20)
# was:	sw	_size_17_, 0(_let_b_15_)
	li	x11, 0
# was:	li	_tmp2_20_, 0
	addi	x22, x20, 4
# was:	addi	_addrg_23_, _let_b_15_, 4
	addi	x19, x19, 4
# was:	addi	_arr_16_, _arr_16_, 4
	mv	x21, x0
# was:	mv	_ind_var_18_, x0
l.loop_beg_21_:
	bge	x21, x18, l.loop_end_22_
# was:	bge	_ind_var_18_, _size_17_, l.loop_end_22_
	lw	x10, 0(x19)
# was:	lw	_tmp1_19_, 0(_arr_16_)
	addi	x19, x19, 4
# was:	addi	_arr_16_, _arr_16_, 4
# 	mv	x10,_tmp1_19_
# 	mv	x11,_tmp2_20_
...
# 	mv	_tmp_24_,x10
	mv	x11, x10
# was:	mv	_tmp2_20_, _tmp_24_
	sw	x11, 0(x22)
# was:	sw	_tmp2_20_, 0(_addrg_23_)
	addi	x22, x22, 4
