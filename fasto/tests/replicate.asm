...
# was:	add	x3, x3, _tmp_10_
	sw	x11, 0(x10)
# was:	sw	_size_3_, 0(_let_fs_2_)
	addi	x14, x10, 4
# was:	addi	_addr_5_, _let_fs_2_, 4
	mv	x13, x0
# was:	mv	_i_6_, x0
l.loop_beg_8_:
	bge	x13, x11, l.loop_end_9_
# was:	bge	_i_6_, _size_3_, l.loop_end_9_
	sb	x12, 0(x14)
# was:	sb	_a_4_, 0(_addr_5_)
	addi	x14, x14, 1
