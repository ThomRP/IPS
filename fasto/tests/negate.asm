...
# was:	mv	_let_x0_10_, x10
	li	x10, 3
# was:	li	_NEGATE_exp_24_, 3
	sub	x11, x0, x10
# was:	sub	_divide_L_22_, x0, _NEGATE_exp_24_
	li	x10, 2
...
# was:	div	_eq_L_20_, _divide_L_22_, _divide_R_23_
	li	x11, 2
# was:	li	_NEGATE_exp_26_, 2
	sub	x12, x0, x11
# was:	sub	_eq_R_21_, x0, _NEGATE_exp_26_
	li	x11, 0
# was:	li	_arg_19_, 0
	bne	x10, x12, l.false_27_
...
# was:	li	_NEGATE_exp_34_, 2
	sub	x11, x0, x11
# was:	sub	_divide_R_33_, x0, _NEGATE_exp_34_
...
# was:	div	_eq_L_30_, _divide_L_32_, _divide_R_33_
	li	x11, 2
# was:	li	_NEGATE_exp_36_, 2
	sub	x12, x0, x11
# was:	sub	_eq_R_31_, x0, _NEGATE_exp_36_
	li	x11, 0
# was:	li	_arg_29_, 0
...
# was:	mv	_let_x2_28_, x10
	li	x10, 3
# was:	li	_NEGATE_exp_44_, 3
	sub	x10, x0, x10
# was:	sub	_divide_L_42_, x0, _NEGATE_exp_44_
	li	x11, 2
# was:	li	_NEGATE_exp_45_, 2
	sub	x11, x0, x11
# was:	sub	_divide_R_43_, x0, _NEGATE_exp_45_
...
# was:	beq	x0, _and_L_53_, l.sc_l_56_
# 	mv	_NOT_exp_55_,_let_x1_18_
	xori	x11, x18, 1
# was:	xori	_and_R_54_, _NOT_exp_55_, 1
	and	x11, x19, x11
# was:	and	_and_L_51_, _and_L_53_, _and_R_54_
	j	l.end_l_57_
l.sc_l_56_:
	mv	x11, x0
# was:	mv	_and_L_51_, x0
l.end_l_57_:
	beq	x0, x11, l.sc_l_59_
# was:	beq	x0, _and_L_51_, l.sc_l_59_
# 	mv	_NOT_exp_58_,_let_x2_28_
	xori	x12, x20, 1
# was:	xori	_and_R_52_, _NOT_exp_58_, 1
	and	x11, x11, x12
# was:	and	_and_L_49_, _and_L_51_, _and_R_52_
	j	l.end_l_60_
l.sc_l_59_:
	mv	x11, x0
# was:	mv	_and_L_49_, x0
l.end_l_60_:
	beq	x0, x11, l.sc_l_61_
# was:	beq	x0, _and_L_49_, l.sc_l_61_
